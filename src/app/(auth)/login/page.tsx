...
export default function LoginPage() {
  ...
  return (
    <div className="space-y-6 text-left">
      <div>
        <h2 className="text-xl font-black text-white tracking-tight">Welcome Back, Traveler</h2>
        <p className="text-xs text-xploria-muted font-semibold mt-1">
          Access your personalized travel itineraries and budgets.
        </p>
      </div>
      ...
      <div className="text-center text-xs text-xploria-muted pt-4 border-t border-[#24262c]">
        ...
        <Link href="/register" className="text-xploria-primary hover:underline font-bold">
          Create one
        </Link>
      </div>
    </div>
